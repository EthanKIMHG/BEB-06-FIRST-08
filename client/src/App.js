      ...
      <div className="nav-wrapper">
        <nav className="navbar-main">
          ...
          <div className="nav-search" style={{ width: "100%" }}>
            ...
            <div className="nav-search2" style={{ height: "100%", width: "100%" }}>
                  ...
                  <div className="nav-search-only2">
                    <div className="search-container" style={{ height: "72px,45px" }}>
                      <div className="search-wrapper" aria-expanded="false" aria-controls="NavSearch--results" role="combobox">
                        <div className="search-icon" color="rgba(255,255,255,0.7)">
                          <i color="currentColor" value="search" size="24" class="material-icons"></i>
                          <BsSearch size="24" />
                        </div>
                        <input aria-label="Search OpenSea" aria-multiline="false" placeholder="Search items, collections, and accounts" role="searchbox" type="search" value={input} onChange={handleChange} style={{ type: "cursor" }} />
                      </div>
                    </div>
                  </div>
                </div>
